...
<!-- We pre-registered to exclude participants with mean RT < 4000, and this seems to have been a pretty good point to choose. -->
...
```{r binomial priors, eval = FALSE, warning = FALSE, message=FALSE}
Prior <- c(
    set_prior("student_t(6, 0, 1.5)", class = "Intercept"),
    set_prior("student_t(6, 0, 1.5)", class = "b"),
    set_prior("cauchy(0, 10)", class = "sd")
